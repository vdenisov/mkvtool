...
/**
 * Root command. Alongside the hidden `native-smoke` build probe, the eight user-facing subcommands are
 * `to-utf8`, `fix-srt`, `propedit`, `find-unused-fonts`, `fetch-episodes`, `rename`, `inspect` and `mux`.
